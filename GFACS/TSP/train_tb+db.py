...
def train_instance(
    ...
    for pyg_data, distances in data:
        heu_vec, logZs, x_1 = model(pyg_data, return_logZ=True)
        ...
        backward_flow = 0 - (weighted_advantage.detach())* beta +Z_b
        ...
        if guided_exploration:
            ...
            forward_flow_nls = forward_nls + Z_nls - (reward_f_nls.detach())* beta#logZ #Z
            backward_flow_nls = 0 - (reward_nls.detach())* beta +Z_b_nls
...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--output", type=str, default="../pretrained/tsp_gfacs_diffusion_1000",
    ...
    if args.beta_min is None:
        beta_min_map = {100:100, 200: 200, 500: 200, 1000: 200 if args.pretrained is None else 1000}
